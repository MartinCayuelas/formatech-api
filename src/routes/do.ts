...
doRouter.get('/', (req: Request, res: Response) => {
  displayDO(req, res);
});

//Insert in the DB
doRouter.post('/', [checkJwt], (req: Request, res: Response) => {
  res.type('application/json');
  addElementInDO(req, res);
});

//Update in the DB
doRouter.put('/modifier/:id', [checkJwt], (req: Request, res: Response) => {
  res.type('application/json');
...
doRouter.delete('/supprimer/:id', [checkJwt], (req: Request, res: Response) => {
  res.type('application/json');
