...
sagesseRouter.get('/:formation/', (req: any, res: any) => {
...
sagesseRouter.get('/:formation/subject/:id/', (req: any, res: any) => {
  res.type('application/json');
  res.status(200);
  if(req.params.formation=="DO"){
...
sagesseRouter.get('/:formation/module/:id/', (req: any, res: any) => {
  res.type('application/json');
  res.status(200);
  if(req.params.formation=="DO"){
...
sagesseRouter.get('/:formation/semester/:id/', (req: any, res: any) => {
  res.type('application/json');
  res.status(200);
  if(req.params.formation=="DO"){
...
sagesseRouter.get('/:formation/year/:id/', (req: any, res: any) => {
  res.type('application/json');
  res.status(200);
  if(req.params.formation=="DO"){
